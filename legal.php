...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/legal-css.html">
  ...
  <body>
    ...
    <section class="header">
      <div class="topnav">
        ...
        <div id="myLinks">
          ...
          <a href="investment-plan.html">Investment-plan</a>
          <a href="investment-plan.html">FAQs</a>
          <a id="login" href="sign1-in.html">Login</a>
          <a id="create" href="signup1.html">Create account</a>
        </div>
    ...
    <section class="Legal-Section">
      ...
      <div class="legal-info">
        ...
        <h5>Last Updated 13, 2022</h5>
          <p>This is an agreement between Saint Bitts LLC (“Bitcoin.com”, “we”, “us”, or “our”) a company registered in Nevis and you (together with BIG MONEY com, the “Parties” and each a “Party”). By using the BIG MONEY website (the “Site”) and any services available within the Site (collectively the “Services”), you agree that you have read, understood, and accept all of the terms and conditions contained herein (the "User Agreement"), as well as our Privacy Policy, and Cookie Policy.</p>

        <h3>General Use</h3>
          <p> a. Eligibility: By using our Services and entering into this User Agreement, you affirm that you are an individual, at least 18 years of age or older, have the capacity to enter into this User Agreement and agree to be legally bound by the terms and conditions of this User Agreement, including the Cookie Policy, the Privacy Policy and Service Terms when applicable. <br>

          b. Modification: We may change the terms of this User Agreement at any time. Any such changes shall take effect when posted on the Site, or when you use the Services. Read the User Agreement carefully on each occasion you use the Services. Your continued use of the Services shall signify your acceptance to be bound by the current User Agreement.</p>
          <br>
        <h1>Compliance with Applicable Law</h1>
          <p> Your relationship with BIG MONEY and use of any of the Services may be subject to the laws, regulations, and rules of governmental or regulatory authorities in your or our jurisdiction (the “Applicable Law”). By entering into this User Agreement, you agree to act in compliance with and be legally bound to any and all Applicable Law.</p>
        <br>
        <h1>Accessing the Services</h1>
          <p> a. Limited License: We grant you a limited, non-exclusive, non-transferable license to access and use the Services and the Site solely in accordance with the terms of this User Agreement.

          b. Credentials: You must keep secret all credentials associated with the Services. You are solely responsible for managing and maintaining the security of any information relating to such credentials and agree that BIG MONEY shall not be held responsible (and you shall not hold us responsible) for any unauthorised access to the Services or any resulting harm you may suffer.
          
          c. Compliance: Your access to one or more Services may be contingent upon creating a user account and satisfying our onboarding processes as well as our Compliance Program. “Compliance Program” means the requirements set by BIG MONEY for collecting, verifying, recording and reporting information about you, upon first accessing certain Services and on an ongoing basis, whether for our business risk-management purposes or to comply with legal requirements applicable to us. The information we request may include, without limitation, personally identifiable information such as network address, name, email, address, telephone number, date of birth, taxpayer identification or social security number, official government-issued photo identification, and bank account information or other information we may reasonably deem helpful in satisfying our risk management or legal obligations. In providing this information to us you represent that it is accurate and agree to update your information promptly, but in no event later than 14 days following any change in your information. Failure to provide information or update your user account promptly may result in Services being unavailable to you.
          
          d. Communications: Any and all communications from BIG MONEY may be provided to you via electronic mail at the address you provided when accessing the Services. BIG MONEY shall not be responsible for any harm you may suffer as a result of your failure to receive any notice provided to you in connection with this User Agreement or your use of Services so long as such notice is provided to such email address.
          
          e. Termination: We may close, terminate, enable, or disable any or all of the Services or your access to the Services at any time and for any reason.</p>
          
          <h1>Risks of Digital Assets</h1>
          <p>Please note that all transactions involving digital assets such as BIG MONEY Cash, and Ether involve substantial risks. You should therefore carefully consider whether using our Services is suitable for you in light of your financial condition. In considering whether to hold digital assets, you should be aware that the price or value of a digital asset can change rapidly, decrease, and potentially even fall to zero. Past performance is not an indicator of future performance. You acknowledge that we are not responsible for any loss of your digital asset, resulting from theft, loss, or mishandling of private keys outside our control.
          ...
          We do not provide investment advice and any content contained on the Site should not be considered as a substitute for tailored investment advice. The contents of our Site and the Services should not be used as a basis for making investment decisions.</p>
          
          <h3>Representations, Warranties, Indemnification, and Limitations of Liability</h3>
          <p>a. Acceptable Use of BIG MONEY Services: When accessing or using the Services, you agree that you are solely responsible for your conduct while accessing and using our Services. Without limiting the generality of the foregoing, you agree that you shall not:
          ...
          d. Indemnification. You agree to indemnify and hold harmless BIG MONEY com, its affiliates, subsidiaries, directors, managers, members, officers, and employees from any and all claims, demands, actions, damages, losses, costs or expenses, including without limitation, reasonable legal fees, arising out of or relating to: (a) your use of the Site or Services; (b) breach of this User Agreement or any other policy; (c) feedback or submissions you provide; (d) false, incomplete, or misleading information relied upon by us to verify your identity and source of funds, where applicable; or (e) violation of any rights of any other person or entity; provided however, that you shall not indemnify BIG MONEY for claims or losses arising out of BIG MONEY gross negligence or willful misconduct. This indemnity shall apply to your successors and assigns and shall survive any termination or cancellation of this User Agreement.

          Any and all of our indemnities, warranties, and limitations of liability (whether express or implied) are hereby excluded to the fullest extent permitted under law except as set forth herein. Nothing in this User Agreement excludes or limits liability which may not be limited or excluded under Applicable Law.</p>
          
          <h3>Dispute Resolution</h3>
          <p>Any disputes between you and us arising from your use of the Site or the Services (whether arising out of contract, tort, statute or any other manner) shall be resolved in the courts of Saint Kitts and Nevis and Saint Kitts and Nevis shall have exclusive jurisdiction over such matters. EXCEPT WHERE PROHIBITED BY APPLICABLE LAW, YOU AGREE THAT ANY CLAIM YOU MAY HAVE AGAINST US SHALL BE BROUGHT INDIVIDUALLY AND YOU SHALL NOT JOIN SUCH CLAIM WITH CLAIMS OF ANY OTHER PERSON OR ENTITY OR BRING, JOIN, OR PARTICIPATE IN A CLASS ACTION AGAINST US. YOU FURTHER AGREE TO EXPRESSLY WAIVE YOUR RIGHT TO A TRIAL BY JURY.</p>
          
          <h3 id="feed">Feedback</h3>
          <p>BIG MONEY strives to improve its Services to address feedback. If you have ideas or suggestions regarding improvements or additions to the Services, we would like to hear them; however, any submission shall be subject to this User Agreement.
          Under no circumstances shall disclosure of any idea or feedback, or any related material to BIG MONEY be subject to any obligation of confidentiality or expectation of compensation.
            
          By submitting an idea or feedback or any related material that would be subject to intellectual property rights (the Work) to BIG MONEY com, you grant to BIG MONEY com, with respect to the Work submitted, a non-exclusive, perpetual, global, royalty-free licence to use all of the content of such ideas and feedback, for any purpose whatsoever.
            
          By submitting Work, you are waiving any moral rights to the fullest extent permitted under law that you may have in the Work and are representing and warranting to BIG MONEY that the Work originated with you, no one else has any rights in the Work, and that BIG MONEY is free of any royalty to implement the Work and to use the related material if so desired, as provided or modified by BIG MONEY com, without obtaining permission or licence from any third party We may sub-license in any way all Work and material you have submitted to BIG MONEY .</p>
      </div>
    </section>
    ...
    <section class="section12">
      <div class="bottn">
        ...
        <div class="comp">
         ...
         <p id="mon"><a href="index.html">Home </a> <br>
          <a href="about us.html">About Us</a>
             <br>
             <a href="investment-plan.html">Investment Approach</a>
            </p> 
        </div>
        <div class="legal">
         <p class="mon">LEGAL</p>
         <p id="mon"><a href="legal.html">Legal Info</a><br>
          <a href="terms&condition.html">Privacy Policy </a><br>
          <a href="terms&condition.html">Terms and Agreements</a>
          <br>      
          <a href="contacts.html">Report Abuse</a>  
          </p>
        </div>
        <div class="contact">
